...
public class ResourceAccessControlService {
    ...
    public Mono<Oauth2TokenInfo> validateTokenAndCheckHasAnyScopes(String token, long... scopes) {
        ...
        return webClient.post()
            ...
            .filter(tokenInfo -> Scope.grantsAny(tokenInfo.getScope(), scopes))
