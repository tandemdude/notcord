...
public class GlobalErrorAttributes extends DefaultErrorAttributes {
    ...
    public Map<String, Object> getErrorAttributes(ServerRequest request, ErrorAttributeOptions errorAttributeOptions) {
        ...
        var problemDetail = switch (exc) {
            case UnsupportedMediaTypeStatusException ex -> onUnsupportedMediaTypeException(ex);
            case WebExchangeBindException ex -> onWebExchangeBindException(ex);
            case ResponseStatusException ex -> onResponseStatusException(ex, request);
            default -> onException(exc);
        };
